...
namespace Microsoft::Console::Render
{
    ...
    private:
        ...
        void _PaintBufferOutputHelper(_In_ IRenderEngine* const pEngine, TextBufferCellIterator it, std::vector<QuickSelectSelection> rects, const til::point coordTarget);
