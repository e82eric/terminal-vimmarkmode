...
#pragma warning(suppress : 26432) // If you define or delete any default operation in the type '...', define or delete them all (c.21).
        ...
        [[nodiscard]] virtual HRESULT PaintYankSelection(const til::rect& rect) noexcept = 0;
        [[nodiscard]] virtual HRESULT PatchLine(til::point point, std::vector<wchar_t> cluster, COLORREF fgColor) noexcept = 0;
        [[nodiscard]] virtual HRESULT PaintSelections(const std::vector<til::rect>& rects) noexcept = 0;
        [[nodiscard]] virtual HRESULT PaintQuickSelectSelections(const std::vector<til::rect>& rects) noexcept = 0;
