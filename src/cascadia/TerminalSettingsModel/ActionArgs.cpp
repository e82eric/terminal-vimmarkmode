...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    winrt::hstring NewFloatingPaneArgs::GenerateName(const winrt::WARC::ResourceContext& context) const
    {
        winrt::hstring newTerminalArgsStr;
        if (ContentArgs())
        {
        ...
        if (newTerminalArgsStr.empty())
        {
            return RS_switchable_(L"NewFloatingPaneCommandKey");
        }
        return winrt::hstring{
            fmt::format(FMT_COMPILE(L"{}, {}"), RS_switchable_(L"NewFloatingPaneCommandKey"), newTerminalArgsStr)
        };
    }

    winrt::hstring MoveFloatingPaneToSplitArgs::GenerateName(const winrt::WARC::ResourceContext& context) const
    {
        std::wstring str;
        str.append(RS_switchable_(L"MoveFloatingPaneToSplitCommandKey"));
    ...
    winrt::hstring SendInputToPaneArgs::GenerateName(const winrt::WARC::ResourceContext& context) const
    {
        const auto escapedInput = til::visualize_control_codes(Input());
        const auto name = RS_switchable_fmt(L"SendInputCommandKey", escapedInput);
        return winrt::hstring{ name };
    ...
    winrt::hstring QuickSelectArgs::GenerateName(const winrt::WARC::ResourceContext& context) const
    {
        return RS_switchable_(L"QuickSelectCommandKey");
    }
