    ...
    winrt::hstring ActionAndArgs::GenerateName(const winrt::Windows::ApplicationModel::Resources::Core::ResourceContext& context) const
    {
        ...
        static const auto GeneratedActionNames = []() {
            return std::unordered_map<ShortcutAction, wil::zwstring_view>{
                ...
                { ShortcutAction::DuplicatePaneAsFloat, USES_RESOURCE(L"DuplicatePaneAsFloatCommandKey") },
                { ShortcutAction::ToggleFloatingPane, USES_RESOURCE(L"ToggleFloatingPaneCommandKey") },
                { ShortcutAction::MovePaneToFloatingPane, USES_RESOURCE(L"MovePaneToFloatingPaneCommandKey") },
                ...
                { ShortcutAction::MoveFloatingPaneToSplit, USES_RESOURCE(L"MoveFloatingPaneToSplitCommandKey") },
                ...
                { ShortcutAction::QuickSelect, USES_RESOURCE(L"QuickSelectCommandKey") },
                ...
                { ShortcutAction::SearchSnippets, USES_RESOURCE(L"SearchSnippetsKey") },
                { ShortcutAction::VimSearch, USES_RESOURCE(L"VimSearchKey") },
                { ShortcutAction::ToggleRowNumbers, USES_RESOURCE(L"ToggleRowNumbersCommandKey") },
                { ShortcutAction::ToggleSnippetAutoComplete, USES_RESOURCE(L"ToggleSnippetAutoCompleteKey") },
