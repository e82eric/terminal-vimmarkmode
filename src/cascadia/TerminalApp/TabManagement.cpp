...
namespace winrt::TerminalApp::implementation
{
    ...
    void TerminalPage::_ensureFloatingPaneState(winrt::com_ptr<Tab> tab)
    {
    ...
    void TerminalPage::AddFloatingPane(std::shared_ptr<Pane> pane)
    {
        ...
        auto tab = _GetFocusedTabImpl();
        tab->AttachPaneAsFloat(pane, closeToken);
        _ensureFloatingPaneState(tab);
    }

    void TerminalPage::HideFloatingPaneElements(winrt::com_ptr<Tab> tab)
    {
        tab->SetFloatingPaneVisibility(false);
        _ensureFloatingPaneState(tab);
    }
