...
namespace winrt::TerminalApp::implementation
{
    ...
    std::shared_ptr<Pane> Tab::GetFloatPane() const
    {
        ASSERT_UI_THREAD();
    ...
    void Tab::RemoveFloatPane(std::shared_ptr<Pane> pane)
    {
        ASSERT_UI_THREAD();
    ...
    bool Tab::HasFloatPane() const
    {
        return _floatingPanes.size() > 0;
    }

    bool Tab::FloatingPaneVisible() const
    {
        return HasFloatPane() && _floatingPaneVisible;
    }

    void Tab::SelectNextFloatingPane()
    {
    ...
    void Tab::SelectPreviousFloatingPane()
    {
        auto newIndex = _activeFloatingPaneIndex - 1;
        if (newIndex < 0)
        {
    ...
    std::shared_ptr<Pane> Tab::DetachFloatPane()
    {
    ...
    void Tab::MoveFloatPaneToSplit(SplitDirection direction)
    {
        ASSERT_UI_THREAD();
    ...
    void Tab::AttachPaneAsFloat(std::shared_ptr<Pane> pane, winrt::event_token closeToken)
    {
        ASSERT_UI_THREAD();
    ...
    void Tab::SetFloatingPaneVisibility(bool value)
    {
