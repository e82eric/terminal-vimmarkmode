...
#pragma region IRenderData
    ...
    std::optional<til::point_span> _GetVimCursor() const noexcept;
...
private:
    ...
    mutable std::optional<til::point_span> _lastVimCursor{};
...
#pragma region TextSelection
    // These methods are defined in TerminalSelection.cpp
    std::vector<til::point_span> _GetYankSelectionRects() const noexcept;
...
public:
    ...
    void SetQuickSelectHighlights(const std::vector<til::point_span>& highlights) noexcept;
};
