...
bool QuickSelectAlphabet::Enabled()
{
    return _enabled;
}
...
std::vector<Microsoft::Console::Render::QuickSelectSelection> QuickSelectAlphabet::GetQuickSelectChars(int32_t number) noexcept
try
{
...
bool QuickSelectAlphabet::AllCharsSet(int32_t number)
{
    int columns = 1;
    while (std::pow(_quickSelectAlphabet.size(), columns) < number)
    {
