...
namespace winrt::Microsoft::Terminal::Control::implementation
{
    ...
    struct Search2TextLine : Search2TextLineT<Search2TextLine>
    {
        ...
        Search2TextLine(const Windows::Foundation::Collections::IObservableVector<winrt::Microsoft::Terminal::Control::Search2TextSegment>& segments, int32_t score, int32_t row, int32_t firstPosition);
