...
std::pair<til::point, bool> TextBuffer::GetEndOfPreviousWord(const til::point target, const std::wstring_view wordDelimiters) const
{
    auto wordStart = GetStartOfWord(target, wordDelimiters);
